...
<body>
	...
	<?php
	 ...
	 $sql = "SELECT Title, Description, IMFileName, Date FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Measures ='Total No.of Patents Filed'";
	...
	?>
			...
			<div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
						Total no. of Other IPR (Other than patent) <br>eg: trademark, industrial design,circuit,software, lyric, poems, new microbial spesies,new plant variety,utility innovations,geographical indication, layout design,teaching aids,copyrights etc.)
						</div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
	...
	<?php
	$sql = "SELECT Title, Description, IMFileName, Date FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Measures ='Total No. of Other IPR (Other than patent)'";
	$result = $conn->query($sql);
