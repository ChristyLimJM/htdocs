...
<body>
	...
	<a href=" /KPI/logout.php?logout"  class="btn btn-danger square-btn-adjust">Logout</a> 
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Services Rendered by Staff</h2>   
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            No. of Courses Conducted/ Laboratory Offering Services/ Consultation or Any Other Related Activities
                        </div>
	...
	$sql = "SELECT Title, Description, IMFileName, Date FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Measures ='No. of Courses Conducted/ Laboratory Offering Services/ Consultation or any Other Related Activities'";
