					...
					<div class="row">
						<div class="col-md-4 col-sm-6 col-xs-6">           
							<div class="panel panel-back noti-box">
								...
								<div class="text-box" >
									<p class="main-text" >
									<a href=" /KPI/managementlecturerRecognition.php" style="color:#000033">
						...
						<div class="col-md-4 col-sm-6 col-xs-6">           
							<div class="panel panel-back noti-box">
								...
								<div class="text-box" >
									<p class="main-text">
									<a href=" /KPI/managementlecturerResearch.php" style="color:#000033">
						...
						<div class="col-md-4 col-sm-6 col-xs-6">           
							<div class="panel panel-back noti-box">
								...
								<div class="text-box" >
									<p class="main-text">
									<a href=" /KPI/managementlecturerAward.php" style="color:#000033">
									AWARD</a>
									</p>
