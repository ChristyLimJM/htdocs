...
<head>
    ...
    <title>FSKTM KPI : RECOGNITION & PROFESSIONAL SERVICES</title>
	<!-- BOOTSTRAP STYLES-->
...
<body>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Report</h2> 
					<h3>RECOGNITION & PROFESSIONAL SERVICES</h3>
                    </div>
                </div>
	...
	$sql = "SELECT Title, Category, KPI, Measures FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Category ='Recognition & Professional Services'";
