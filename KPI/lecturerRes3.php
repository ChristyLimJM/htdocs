...
<body>
	...
	<a href=" /KPI/logout.php?logout"  class="btn btn-danger square-btn-adjust">Logout</a> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
						...
						Total No. of Academic as Principal Investigator
						</div>
	 ...
	 $sql = "SELECT Title, Description, IMFileName, Date FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Measures ='Total No. of Academic as Principal Investigator'";
