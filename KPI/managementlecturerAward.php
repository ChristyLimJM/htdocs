...
<body>
			...
			<nav class="navbar-default navbar-side" role="navigation">
				<div class="sidebar-collapse">
					<ul class="nav" id="main-menu">
						...
						<li>
							<a href="managementlecturerUpload.php"><i class="fa fa-picture-o fa-3x"></i> UPLOAD</a>
						</li>            
						<li>
	...
	$result1 =  mysqli_num_rows(mysqli_query($conn, "SELECT * FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND KPI='Student'"));
					...
					<div class="row">
						<div class="col-md-4 col-sm-6 col-xs-6">           
							<div class="panel panel-back noti-box"> 
								<div class="text-box" >
									<p class="main-text">
									<a href="  /KPI/managementlecturerAwd1.php" style="color:#000033">
									Student</a></p>
						...
						<div class="col-md-4 col-sm-6 col-xs-6">           
							<div class="panel panel-back noti-box">
								<div class="text-box" >
									<p class="main-text">
									<a href="  /KPI/managementlecturerAwd2.php" style="color:#000033">
									Staff</a></p>
									<p class="text-muted"></p>
