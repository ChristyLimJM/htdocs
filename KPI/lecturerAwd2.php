...
<body>
					...
					<div class="row">
						...
						<div class="row">
							...
							<div class="panel panel-default">
								...
								No. of External Recognition and Award Received by Staff <br>(i.e. certificate of appreciation, trophy, sport achievement, community service, panel of jury, consultation skill, expert panel in mass media)
								</div>
	...
	<?php
		...
		$sql = "SELECT Title, Description, IMFileName, Date FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Measures ='No. of External Recognition and Award Received by Staff'";
