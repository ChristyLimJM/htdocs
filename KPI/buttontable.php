...
<head>
    ...
    <title>FSKTM KPI : RESEARCH, PUBLICATION & INNOVATION</title>
	<!-- BOOTSTRAP STYLES-->
...
<body>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Report</h2>   
					 <h3>RESEARCH, PUBLICATION & INNOVATION</h3>
                    </div>
                </div>
                <!-- /. ROW  -->
                 <hr />
    ...
    <?php
	 ...
	 $sql = "SELECT Title, Category, KPI, Measures FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Measures ='No. of Recognition and Award Received by Student'";
