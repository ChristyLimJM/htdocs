...
<body>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Total No. of Consultation Activity
                        </div>
	...
	<?php
	 ...
	 $sql = "SELECT Title, Description, IMFileName, Date FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Measures ='Total No. of Consultation Activity'";
