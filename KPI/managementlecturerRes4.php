...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
						...
						Public Grants (RU,FRGS,ERGS,LRGS,SF,government agencies, MOSTI etc)
						</div>
	...
	<?php
	 ...
	 $sql = "SELECT Title, Description, IMFileName, Date FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Measures ='Public Grants'";
	...
	?>
			...
			<div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
						Total No. of Academic Staff Apply FRGS / External Public Grants
						</div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
	...
	<?php
	 $sql = "SELECT Title, Description, IMFileName, Date FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Measures ='Total No. of Academic Staff Apply FRGS /External Public Grants'";
	 $result = $conn->query($sql);
...
?>
	...
	<?php
	 ...
	 $sql = "SELECT Title, Description, IMFileName, Date FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Measures ='National Private/Industries'";
	 $result = $conn->query($sql);
	...
	<?php
	 ...
	 $sql = "SELECT Title, Description, IMFileName, Date FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Measures ='International'";
	 $result = $conn->query($sql);
