...
<html >
	...
	<body>
		...
		?>
			...
			<button type = "click">
			<a href = " /KPI/hodhomepage.php" style="text-decoration: none ; color : #180000"> HEAD OF DEPARTMENT </a>
			</button>
			...
			<button type = "logout">
			<a href= "logout.php?logout" style="text-decoration: none ; color : #F5FFFA">Logout</a>
			</button>
