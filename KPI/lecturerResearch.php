					...
					<div class="row">
						<div class="col-md-4 col-sm-6 col-xs-6">           
							<div class="panel panel-back noti-box"> 
								<div class="text-box" >
									<p class="main-text">
									<a href="lecturerRes1.php" style="color:#000033">
									Consultation</a></p>
						...
						<div class="col-md-4 col-sm-6 col-xs-6">           
							<div class="panel panel-back noti-box">
								<div class="text-box" >
									<p class="main-text">
									<a href="lecturerRes2.php" style="color:#000033">
									Publication</a></p>
									<p class="text-muted"></p>
						...
						<div class="col-md-4 col-sm-6 col-xs-6">           
							<div class="panel panel-back noti-box">
								<div class="text-box" >
									<p class="main-text">
									<a href="lecturerRes3.php" style="color:#000033">
						...
						<div class="col-md-4 col-sm-6 col-xs-6">           
							<div class="panel panel-back noti-box">
								<div class="text-box" >
									<p class="main-text">
									<a href="lecturerRes4.php" style="color:#000033">
									Research Grant</a></p>
									<p class="text-muted"></p>
						...
						<div class="col-md-4 col-sm-6 col-xs-6">           
							<div class="panel panel-back noti-box">
								<div class="text-box" >
									<p class="main-text">
									<a href="lecturerRes5.php" style="color:#000033">
									Innovation</a></p>
									<p class="text-muted"></p>
