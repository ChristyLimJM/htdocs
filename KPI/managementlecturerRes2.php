...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
						...
						Total No. of ISI Publication / Clinical & Science Category -ISI only / Non-Science Category - ISI/Scopus
					</div>
	...
	<?php
	 ...
	 $sql = "SELECT Title, Description, IMFileName, Date FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Measures ='Total No. of ISI Publication / Clinical & Science Category -ISI only / Non-Science Category - ISI/Scopus'";
	...
	?>
			...
			<div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
						Total No. of Research/ Reference Books
						</div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
	...
	$sql = "SELECT Title, Description, IMFileName, Date FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Measures ='Total No. of Research/ Reference Books'";
	$result = $conn->query($sql);
...
?>
			...
			<div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
						Other Publications (Chapter in book, scopus, conference proceeding, technical report, policy, newspaper/ magazine, newsletter)
	...
	$sql = "SELECT Title, Description, IMFileName, Date FROM evidence WHERE StaffID = '".$_SESSION["user"]."' AND Measures ='Other Publications'";
	$result = $conn->query($sql);
